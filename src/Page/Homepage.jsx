            ...
            <Carousel className="rounded-5 shadow-4-strong">
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    ...
                    Realm, interacting with strange new creatures and embarking
                    on an adventure that pushes them beyond the limits of what
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    ...
                    Sully family (Jake, Neytiri, and their kids), the trouble
                    that follows them, the lengths they go to keep each other
                    safe
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    Tasked with escorting a teenager across a post-apocalyptic
                    world, a dreaded smuggler joins hands with a young
                    apprentice to fulfil the mission unscathed.
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
            </Carousel>
            ...
            <Carousel className="rounded-5 shadow-4-strong">
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    Andy Dufresne, a successful banker, is arrested for the
                    murders of his wife and her lover, and is sentenced to life
                    imprisonment at the Shawshank prison. He becomes the most
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  <h3>The Godfather</h3>
                  <p>
                    Don Vito Corleone, head of a mafia family, decides to hand
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  <h3>Parasite</h3>
                  <p>
                    The struggling Kim family sees an opportunity when the son
                    starts working for the wealthy Park family. Soon, all of
                    them find a way to work within the same household and start
